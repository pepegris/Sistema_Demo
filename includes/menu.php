...
<nav id="navegador">
        ...
        <ul>
            ...
            <li><a href="../Factura/facturar_nueva.php">Factura</a></li>
            <li><a href="../router/articulos.php">Articulos</a></li>
            <li><a href="../router/clientes.php">Clientes</a></li>
            <li><a href="../router/vendedores.php">Vendedores</a></li>
            <li><a href="../router/registrar.php">Nuevo Usuario</a></li>
        </ul>
    </nav>
...
<nav id="navbar" class="navbar">
    <ul id="navbar-nav" class="navbar-nav">
      ...
      <li id="nav-item" class="nav-item">
        <a href="../router/factura.php" id="nav-link" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
  ...
  <!--     <li id="nav-item" class="nav-item">
      ...
      <li id="nav-item" class="nav-item">
        <a href="../articulos/articulo.php" id="nav-link" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li id="nav-item" class="nav-item">
        <a href="../router/vendedores.php" id="nav-link" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
          ...
          <span id="link-text" class="link-text">Vendedores</span>
        </a>
      </li>
